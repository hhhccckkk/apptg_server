					...
					<tbody>
						<h:iterator value="users" var="u">
							<tr>
								...
								<td><a href="getOneUser?id=<h:property value="#u.id"/>"><h:property
											value="#u.isok" /></a></td>
								<td><a href="getUserOrder?uid=<h:property value="#u.id"/>">发帖记录</a></td>
								<td><a
									href="updateState?&isok=1&id=<h:property value="#u.id"/>">启用</a></td>
								<td><a
									href="updateState?&isok=0&id=<h:property value="#u.id"/>">禁用</a></td>
								<td><a href="deleteUser?id=<h:property value="#u.id"/>">
						...
						<tr class=" ">
							...
							<td colspan="7" class="checkBox">共找到 <%=maxnum%>
								...
								href="getusers?page=<%=1 >= pagenum ? pagenum : 1%>" class="STYLE6">1</a>&nbsp;
								<a href="getusers?page=<%=2 >= pagenum ? pagenum : 2%>"
								class="STYLE6">2</a>&nbsp; <a
								href="getusers?page=<%=3 >= pagenum ? pagenum : 3%>" class="STYLE6">3</a>&nbsp;
								<a href="getusers?page=<%=4 >= pagenum ? pagenum : 4%>"
								class="STYLE6">4</a>&nbsp; <a
								href="getusers?page=<%=5 >= pagenum ? pagenum : 5%>" class="STYLE6">5</a>&nbsp;
								<a href="getusers?page=<%=6 >= pagenum ? pagenum : 6%>"
								class="STYLE6">6</a>&nbsp; <a
								href="getusers?page=<%=7 >= pagenum ? pagenum : 7%>" class="STYLE6">7</a>&nbsp;
								<a href="getusers?page=<%=8 >= pagenum ? pagenum : 8%>"
								class="STYLE6">8</a>&nbsp; <a
								href="getusers?page=<%=9 >= pagenum ? pagenum : 9%>" class="STYLE6">9</a>&nbsp;
								<a href="getusers?page=<%=10 >= pagenum ? pagenum : 10%>"
								class="STYLE6">10</a>&nbsp; <a
