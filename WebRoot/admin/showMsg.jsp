		...
		<div id="widget table-widget">
			...
			<div class="pageColumn">
				...
				<table>
					...
					<tbody>
						<h:iterator value="tongzhis" var="msg">
							<tr>
								<td><h:property value="#msg.id" /></td>
								<td><h:property value="#msg.content" /></td>
								<td><h:property value="#msg.shijian" /></td>
								<td>
								<a href="deleteTZ?id=<h:property value="#msg.id"/>">
